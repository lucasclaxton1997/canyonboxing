        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-8 mt-12 border-t border-white/10 pt-8">
              <div>
                <span className="block text-4xl font-heading font-bold text-white uppercase">10+</span>
                <span className="text-sm text-gray-400 uppercase tracking-widest">Years Experience</span>
              </div>
              <div>
                <span className="block text-4xl font-heading font-bold text-white uppercase">6</span>
